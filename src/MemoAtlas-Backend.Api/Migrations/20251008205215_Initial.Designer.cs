...
namespace MemoAtlas_Backend.Api.Migrations
{
    ...
    [Migration("20251008205215_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.Prompt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.PromptAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.TagGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.PromptAnswer", b =>
                {
                    b.HasOne("MemoAtlas_Backend.Api.Models.Entities.Memo", "Memo")
                        .WithMany("PromptAnswers")
                        .HasForeignKey("MemoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MemoAtlas_Backend.Api.Models.Entities.Prompt", "Prompt")
                        .WithMany("PromptAnswers")
            ...
            modelBuilder.Entity("MemoAtlas_Backend.Api.Models.Entities.Tag", b =>
                {
                    b.HasOne("MemoAtlas_Backend.Api.Models.Entities.TagGroup", "TagGroup")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("MemoTag", b =>
                {
                    b.HasOne("MemoAtlas_Backend.Api.Models.Entities.Memo", null)
                        .WithMany()
